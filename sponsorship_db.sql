...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 11 jan. 2024 à 21:52
...
--
-- Base de données : `sponsorship_db`
--
...
(1, 'ADMIN', 'Administrateur', 'admin', 'admin', 1, 1);
...
--
-- AUTO_INCREMENT pour la table `parrainer`
--
ALTER TABLE `parrainer`
...
--
-- Contraintes pour la table `parrainer`
--
ALTER TABLE `parrainer`
  ADD CONSTRAINT `parrainer_ibfk_1` FOREIGN KEY (`electeur`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `parrainer_ibfk_2` FOREIGN KEY (`candidat`) REFERENCES `user` (`id`);
